...
public class SandboxArreglos
{
    ...
    public void agregarEntero( int entero )
    {
    	...
    	nuevoArray[arregloEnteros.length] = entero;
    ...
    {
    	String[] nuevoArray = new String[arregloCadenas.length+1];
    	for (int i = 0; i < arregloCadenas.length; i++) {
    	    nuevoArray[i] = arregloCadenas[i];
    	}
    	nuevoArray[arregloCadenas.length] = cadena;
    ...
    public void eliminarEntero( int valor )
    {
    	...
    	int k=0;
    	int[] nuevoArray = new int[arregloEnteros.length-numeroVeces];
    	for (int i = 0; i < nuevoArray.length; i++) {
    	    if (arregloEnteros[i]!=valor) {
    	    	nuevoArray[k] = arregloEnteros[i];
    	    	k++;
    	    }
    	}
    	arregloEnteros = nuevoArray;
    ...
    public void eliminarCadena( String cadena )
    {
    	...
    	int k=0;
    	String[] nuevoArray = new String[arregloCadenas.length-numeroVeces];
    	for (int i = 0; i < nuevoArray.length; i++) {
    	    if (arregloCadenas[i]!=cadena) {
    	    	nuevoArray[k] = arregloCadenas[i];
    	    	k++;
    	    }
    	}
    	arregloCadenas = nuevoArray;
    ...
    public void insertarEntero( int entero, int posicion )
    {
    	...
    	if (posicion < 1) {
    		...
    		for (int i=0; i < arregloEnteros.length-posicion; i++) {
        	    nuevoArray[posicion+i+1] = arregloEnteros[posicion+i];
           	}
    	}
    	arregloEnteros = nuevoArray;
     }	
